...
namespace DrCanoli
{
    class PhysManager
    {
        ...
        //we could also give this a reference
        ...
        private void Jump(/*<whatever player and enemy inherit from> jumper*/)
        {
        ...
        private void Knockback(/*<whatever player and enemy inherit from> wasHit*/)
        {
